...
const PasswordGenerator = () => {
  ...
  return (
    <div className="bg-linear-to-br from-sky-400 via-indigo-500 to-purple-600 rounded-2xl col-span-3 col-start-2 h-2/3 shadow-2xl p-8 flex flex-col items-center text-white justify-between">
      <div className="flex flex-col gap-3 bg-white/20 p-4 rounded-lg items-center">
